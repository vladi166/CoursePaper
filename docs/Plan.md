...
#### 4. Проверка поля «Номер карты» на ввод менее 12 цифр
...
#### 5. Проверка поля «Номер карты» на ввод более 12 цифр

***Шаги выполнения***

1. Нажать кнопку «Купить»
2. В поле «Номер карты» ввести любые 13 цифр
3. В поле «Месяц» ввести номер текущего месяца.
4. В поле «Год» ввести последние две цифры текущего года.
5. В поле «Владелец» ввести фамилию и имя на латинице.
6. В поле «CVC/CVV» ввести три цифры.
...
У поля появляется подсказка: «Неверный формат» и/или «Поле обязательно для заполнения».
