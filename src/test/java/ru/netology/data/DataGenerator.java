...
public class DataGenerator {
    ...
    public static class FormPayment {
        ...
        public static AuthInfo getCardNumberWithWordInNumber() { //буквы и цифры в поле
            return new AuthInfo(
                    "1111 aafg 3333 4444",
                    getRandomMonth(),
                    getYearFutureInPeriod(),
        ...
        public static AuthInfo getMoreDigitsInYearCard() {// более 2 цифр
            return new AuthInfo(
                    getApprovedCardNumber(),
                    getRandomMonth(),
                    getYearFutureInPeriod() + getOneDigit(),
                    getHolder(),
                    getCVC()
            );
        }
    ...
    public static int getStatusCodeSuccess() {
        return 200;
    }

    public static int getStatusCodeClientError() {
        return 400;
    }
